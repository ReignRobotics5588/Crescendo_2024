...
public class Shooter extends SubsystemBase{
        ...
        private final CANSparkFlex m_shooterLeft = new CANSparkFlex(ShooterConstants.kLeftMotorPort, MotorType.kBrushless);
        private final CANSparkFlex m_shooterRight = new CANSparkFlex(ShooterConstants.kRightMotorPort, MotorType.kBrushless);
