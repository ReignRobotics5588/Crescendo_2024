...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    DRIVER_lBumper.whileTrue(Commands.startEnd(()->m_Intake.runMotors(IntakeConstants.intakeBeltSpeed), ()->m_Intake.runMotors(0), m_Intake));
    DRIVER_X_BUTTON_XBOX.whileTrue(Commands.startEnd(()->m_Intake.runMotors(-IntakeConstants.intakeBeltSpeed), ()->m_Intake.runMotors(0), m_Intake));
